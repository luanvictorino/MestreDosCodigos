...
{ IXMLResponseType }
  ...
  IXMLResponseType = interface(IXMLNode)
    ['{D01F3EFB-EE66-4747-B666-0A41B28943A7}']
    { Property Accessors }
...
{ IXML_metaType }
  ...
  IXML_metaType = interface(IXMLNode)
    ['{FAA3CF81-F8BF-4D7F-A8C3-A48C3A80D949}']
    { Property Accessors }
...
{ IXMLRateLimitType }
  ...
  IXMLRateLimitType = interface(IXMLNode)
    ['{829ECF8B-D273-4DD4-8A36-424AC459F9E8}']
    { Property Accessors }
...
{ IXMLResultType }
  ...
  IXMLResultType = interface(IXMLNodeCollection)
    ['{8F7B2F67-4FCD-4D3D-9B3A-2ECA9439CE8F}']
    { Property Accessors }
...
{ IXMLItemType }
  ...
  IXMLItemType = interface(IXMLNode)
    ['{0A41AC86-945A-4C6D-ACCC-957FABDEA2E2}']
    { Property Accessors }
...
{ IXML_linksType }
  ...
  IXML_linksType = interface(IXMLNode)
    ['{3B9494E9-35C7-47BB-B741-B32A94C83A0E}']
    { Property Accessors }
...
{ IXMLSelfType }
  ...
  IXMLSelfType = interface(IXMLNode)
    ['{84E08607-A799-4DEF-8EB7-3E8EEB4AD41F}']
    { Property Accessors }
...
{ IXMLEditType }
  ...
  IXMLEditType = interface(IXMLNode)
    ['{CBE2CAEE-8A74-45A4-AC36-17395AFA1B0E}']
    { Property Accessors }
    function Get_Href: UnicodeString;
    procedure Set_Href(Value: UnicodeString);
    { Methods & Properties }
...
{ IXMLAvatarType }
  ...
  IXMLAvatarType = interface(IXMLNode)
    ['{6F290177-2F57-49BA-A7F6-AB97D354D712}']
    { Property Accessors }
    function Get_Href: UnicodeString;
    procedure Set_Href(Value: UnicodeString);
    { Methods & Properties }
